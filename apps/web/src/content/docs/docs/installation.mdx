...
<Aside type="tip">
  This token is **only for development/sync**. For your production frontend, create a separate token with permissions specific to the content your app needs to read/write.
</Aside>
